...
namespace ImCurveEdit
{
    ...
    struct Delegate
    {
        ...
        virtual bool IsVisible([[maybe_unused]] size_t curveIndex) { return true; }
        virtual CurveType GetCurveType([[maybe_unused]] size_t curveIndex) const { return CurveLinear; }
