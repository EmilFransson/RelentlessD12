...
namespace Relentless
{
	...
	void OutlinerPanel::OnEvent(IEvent& event)
	{
	...
	void OutlinerPanel::SetActiveScene(Scene* pScene) noexcept
	{
		RLS_ASSERT(pScene, "[OutlinerPanel]: Scene is invalid.");
		//m_pScene = pScene;

		m_Table.OnSceneChanged(pScene);
	}

	OutlinerTable& OutlinerPanel::GetTable() noexcept
	{
		return m_Table;
	}
