...
namespace Relentless
{
	...
	public:
		...
		ITreeNode* SetWidgetCallback(InstanceType* instance, void(InstanceType::* method)(ITreeNode*)) noexcept
		{
			m_OnCreateWidgetCallback = [this, instance, method]() { return (instance->*method)(this); };
			return this;
		}
