...
namespace Relentless
{
	...
	protected:
		const FactoryResult& ImportFromFileImpl(const Path& aPath, const Path& aPackagePath, const String& aName, Ref<FeedbackContext> aFeedbackContext = nullptr) noexcept override;
	private:
