...
namespace Relentless
{
	...
	RingBufferAllocator::~RingBufferAllocator() noexcept
	{
		Sync();
		m_ConsumeOffset = 0;
		m_ProduceOffset = 0;
	...
	void RingBufferAllocator::Free(RingBufferAllocation& allocation) noexcept
	{
		std::lock_guard lock(m_Lock);
	...
	void RingBufferAllocator::Sync() noexcept
	{
