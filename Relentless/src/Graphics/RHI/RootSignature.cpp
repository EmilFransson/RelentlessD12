...
namespace Relentless
{
	...
	void RootSignature::Finalize(const char* pName) noexcept
	{
		...
		AddStaticSampler(staticSamplerRegisterSlot++, D3D12_FILTER_COMPARISON_MIN_MAG_LINEAR_MIP_POINT, D3D12_TEXTURE_ADDRESS_MODE_CLAMP, D3D12_COMPARISON_FUNC_LESS_EQUAL);
